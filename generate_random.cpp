...
int main()
{
    ...
    */
    ...
    answer = "It outputs 10 random numbers between zero and randmax" ; // 1. Write your answer to Q1 in between " "
    ...
    answer = "It outputs the remainder of 10 numbers divided by 5 in range 0-4" ; // 2. Write your answer to Q2 in between " "
    ...
    answer = "Outputs +3 to the remainders of 10 numbers divided by 5 in range 3-7" ; // 3. Write your answer to Q3 in between " "
    ...
    answer = "It gives the same set of numbers. srand changes the seed value. By removing, it only uses a single seed." ; // 4. Write your answer to Q4 in between " "
